...
from gpt_utils import ask_nova  # Importa GPT-4o desde tu nuevo archivo

# 🔍 Lógica FRED (para inflación CPI)
...
# 🤖 Lógica GPT-4o (para todo lo demás)
async def responder_gpt(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await update.message.reply_text("⚠️ Error al procesar con GPT.")

# 🧠 Decisión según contenido
async def manejar_mensaje(update: Update, context: ContextTypes.DEFAULT_TYPE):
    texto = update.message.text.lower()
    if "inflación" in texto and "ee.uu" in texto:
